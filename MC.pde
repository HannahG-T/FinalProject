...
void setup(){
  ...
  x=width/2;
  y=height/2;
  expression="almost crying";
  action="standing";
  MCSide(x,y,expression,action);
}

void draw(){}


void MCFront(int x, int y,String expression, String action){
  pushMatrix();
  translate(x,y);
  scale(2);
  //hair 
...
void MCSide(int x, int y,String expression, String action){
  pushMatrix();
  translate(x,y);
  scale(2,2);
  //body
